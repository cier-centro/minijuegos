...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '180px','50px','50px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '283px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '345px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['20.7%', '79px','600px','103px','auto', 'auto'],
                clip: ['rect(0px 600px 91px 0px)'],
                opacity: 1,
                text: "¿Cuántas personas viven sin electricidad?",
            ...
            },
            {
                id: 'respuesta3',
                type: 'text',
                rect: ['26.9%', '345px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Solo los países en guerra.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta2',
                type: 'text',
                rect: ['26.9%', '283px','622px','45px','auto', 'auto'],
                opacity: 1,
                text: "Nadie vive sin electricidad.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta1',
                type: 'text',
                rect: ['26.9%', '181px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Más de 1.200 millones de personas —una de cada cinco personas de la población mundial— viven sin electricidad.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'resp_incorrecta',
    ...
    states: {
        "Base State": {
            ...
            "${_Text}": [
                ["style", "top", '79px'],
                ["style", "clip", [0,600,91,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
...
"bt_validar": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid1431", tween: [ "style", "${_botones}", "background-position", [-72.1,-68.857778222222], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-72.222222222222,0]}], position: 0, duration: 250 },
