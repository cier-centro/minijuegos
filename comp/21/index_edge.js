...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['20.5%', '63px','716px','63px','auto', 'auto'],
                opacity: 1,
                text: "¿Cuáles son los retos más urgentes a que se enfrentan actualmente las ciudades?",
                font: ['Arial, Helvetica, sans-serif', 40, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta4',
                type: 'text',
                rect: ['26.7%', '424px','639px','45px','auto', 'auto'],
                opacity: 1,
            ...
            },
            {
                id: 'respuesta3',
                type: 'text',
                rect: ['26.7%', '358px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Reforzar la resiliencia urbana es crucial para evitar pérdidas humanas, sociales y económicas.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta2',
                type: 'text',
                rect: ['26.7%', '262px','622px','45px','auto', 'auto'],
                opacity: 1,
            ...
            },
            {
                id: 'respuesta1',
                type: 'text',
                rect: ['26.7%', '206px','639px','45px','auto', 'auto'],
                opacity: 1,
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['201px', '205px','50px','50px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['201px', '262px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['201px', '358px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['201px', '424px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
