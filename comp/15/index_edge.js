...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['201px', '120px','738px','103px','auto', 'auto'],
                opacity: 1,
                text: "¿Por qué debo preocuparme por la desigualdad si yo no sufro ningún tipo de discriminación? Marque las respuestas correctas.",
            ...
            },
            {
                ...
                text: "Porque muchos Youtubers no reciben el mismo trato.",
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1446", tween: [ "style", "${_Text}", "top", '87px', { fromValue: '-100px'}], position: 0, duration: 450 },
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1274", tween: [ "style", "${_botones}", "background-position", [-76.388888888889,-70], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-73.611111111111,0]}], position: 250, duration: 0 },
