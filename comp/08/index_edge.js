...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['202px', '120px','640px','103px','auto', 'auto'],
                opacity: 1,
                text: "¿Qué hay que hacer para lograrlo?",
                font: ['Arial, Helvetica, sans-serif', 40, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'TextCopy',
                type: 'text',
                rect: ['26.4%', '175px','583px','30px','auto', 'auto'],
                text: "Interesarnos realmente por la actuación de nuestro gobierno.",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['198px', '171px','49px','50px','auto', 'auto'],
            ...
            },
            {
                id: 'TextCopy2',
                type: 'text',
                rect: ['26.4%', '242px','583px','58px','auto', 'auto'],
                text: "Concienciar a nuestra propia comunidad sobre la realidad de la violencia y sobre la importancia de construir sociedades pacíficas y justas.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'checkbox_2',
            ...
            },
            {
                id: 'TextCopy3',
                type: 'text',
                rect: ['26.4%', '336px','583px','30px','auto', 'auto'],
                text: "Promover la inclusión y el respeto hacia las personas de diferente procedencia, origen étnico, religión, género, orientación sexual u opinión.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'checkbox_3',
                display: 'block',
                type: 'rect',
                rect: ['198px', '332px','49px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                id: 'TextCopy4',
                type: 'text',
                rect: ['26.4%', '431px','583px','30px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['198px', '427px','49px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1467", tween: [ "style", "${_bt_solucion}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                ...
                { id: "eid1446", tween: [ "style", "${_Text}", "top", '102px', { fromValue: '-100px'}], position: 0, duration: 450 },
                ...
                { id: "eid1466", tween: [ "style", "${_hotspot_solucion}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
...
"bt_validar": {
    ...
    states: {
        "Base State": {
            "${_botones}": [
                ...
                ["style", "left", '-43px'],
                ["style", "background-position", [-74.074978298612,0], {valueTemplate:'@@0@@px @@1@@px'} ],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid1275", tween: [ "style", "${_botones}", "background-position", [-74.074978298612,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-74.074978298612,0]}], position: 0, duration: 0 },
                { id: "eid1274", tween: [ "style", "${_botones}", "background-position", [-74.074978298612,-70], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-74.074978298612,0]}], position: 250, duration: 0 },
