...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['20.7%', '90px','724px','98px','auto', 'auto'],
                clip: ['rect(0px 723px 99px 0px)'],
                opacity: 1,
                text: "¿Qué se entiende por “trabajo decente”? Marque las respuestas correctas.<br>",
                font: ['Arial, Helvetica, sans-serif', 40, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta4',
                type: 'text',
                rect: ['26.9%', '397px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Que ofrezca mejores perspectivas de desarrollo personal y favorezca la integración social.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta3',
                type: 'text',
                rect: ['26.9%', '332px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Que tenga seguridad en el lugar de trabajo y protección social para las familias.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta2',
                type: 'text',
                rect: ['26.9%', '268px','622px','45px','auto', 'auto'],
                opacity: 1,
                text: "Tener oportunidades para realizar una actividad productiva que aporte un ingreso justo.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta1',
                type: 'text',
                rect: ['26.9%', '212px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "El trabajo de oficina.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'checkbox_1',
                display: 'block',
                type: 'rect',
                rect: ['203px', '212px','50px','50px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '268px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '331px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '397px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
    ...
    states: {
        "Base State": {
            ...
            "${_Text}": [
                ["style", "top", '90px'],
                ["style", "clip", [0,723,99,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "width", '724px'],
                ["color", "color", 'rgba(38,68,103,1.00)'],
                ["style", "height", '98px'],
                ["style", "opacity", '1'],
...
"bt_validar": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid1431", tween: [ "style", "${_botones}", "background-position", [-75,-70], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-75,0]}], position: 0, duration: 250 },
