...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['20.7%', '90px','639px','63px','auto', 'auto'],
                opacity: 1,
                text: "¿Qué se entiende por “trabajo decente”?<br>",
                font: ['Arial, Helvetica, sans-serif', 40, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta4',
                type: 'text',
                rect: ['26.9%', '408px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Todas la anteriores.",
            ...
            },
            {
                ...
                opacity: 1,
                text: "Que ofrezca mejores perspectivas de desarrollo personal y favorezca la integración social.<br>",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta2',
                ...
                opacity: 1,
                text: "Que tenga seguridad en el lugar de trabajo y protección social para las familias.<br>",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta1',
                type: 'text',
                rect: ['26.9%', '208px','639px','45px','auto', 'auto'],
                opacity: 1,
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '216px','50px','50px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '408px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
