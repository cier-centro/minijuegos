...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['20.7%', '76px','639px','63px','auto', 'auto'],
                opacity: 1,
                text: "¿Cuántas personas viven en las ciudades actualmente en el mundo?",
                font: ['Arial, Helvetica, sans-serif', 40, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta4',
                type: 'text',
                rect: ['26.9%', '401px','639px','45px','auto', 'auto'],
                opacity: 1,
            ...
            },
            {
                id: 'respuesta3',
                type: 'text',
                rect: ['26.9%', '343px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Más de la mitad de la población.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta2',
                type: 'text',
                rect: ['26.9%', '281px','622px','45px','auto', 'auto'],
                opacity: 1,
                text: "Menos de la mitad de la población.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta1',
                type: 'text',
                rect: ['26.9%', '219px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Un tercio de la población.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'checkbox_1',
                display: 'block',
                type: 'rect',
                rect: ['203px', '218px','50px','50px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '281px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '342px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '401px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
