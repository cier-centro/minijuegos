...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['20.7%', '79px','600px','63px','auto', 'auto'],
                opacity: 1,
            ...
            },
            {
                id: 'respuesta4',
                type: 'text',
                rect: ['26.9%', '405px','639px','45px','auto', 'auto'],
                opacity: 1,
            ...
            },
            {
                id: 'respuesta3',
                type: 'text',
                rect: ['26.9%', '339px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Podemos pensar cómo afecta la industria a nuestra vida y bienestar.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta2',
                type: 'text',
                rect: ['26.9%', '234px','622px','45px','auto', 'auto'],
                opacity: 1,
                text: "Utilizando las redes sociales para presionar a los responsables de la formulación de políticas para que den prioridad a los Objetivos de Desarrollo Sostenible.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta1',
                type: 'text',
                rect: ['26.9%', '138px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Establecer normas y reglamentos que garanticen la gestión sostenible de los proyectos e iniciativas empresariales.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'checkbox_1',
                display: 'block',
                type: 'rect',
                rect: ['203px', '137px','50px','50px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '234px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '339px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '405px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
