...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                opacity: 1,
                text: "¿De qué modo me afecta este objetivo en el lugar donde vivo?",
            ...
            },
            {
                ...
                text: "Lucha contra la delincuencia.<br>",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'checkbox_2',
            ...
            },
            {
                ...
                text: "Promueve los derechos humanos.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'checkbox_3',
            ...
            },
            {
                id: 'TextCopy4',
                type: 'text',
                rect: ['26.4%', '422px','583px','30px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['198px', '418px','49px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1468", tween: [ "style", "${_hotspot_solucion}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid1446", tween: [ "style", "${_Text}", "top", '120px', { fromValue: '-100px'}], position: 0, duration: 450 },
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1274", tween: [ "style", "${_botones}", "background-position", [-75,-70], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-73.611111111111,0]}], position: 250, duration: 0 },
