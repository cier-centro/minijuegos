...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['205px', '222px','50px','50px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['205px', '297px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                opacity: 1,
                text: "¿Qué podemos hacer para ayudar?",
            ...
            },
            {
                ...
                opacity: 1,
                text: "Luchando contra el desperdicio de alimentos.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta2',
                type: 'text',
                rect: ['27.1%', '299px','622px','45px','auto', 'auto'],
                opacity: 1,
                text: "Apoyando a los agricultores o a los mercados locales.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta1',
                type: 'text',
                rect: ['26.9%', '223px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Se pueden hacer cambios en la vida cotidiana —en el hogar, en el trabajo y en la comunidad.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'resp_incorrecta',
...
"bt_validar": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid1431", tween: [ "style", "${_botones}", "background-position", [-75,-70], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-72.222222222222,0]}], position: 0, duration: 250 },
