    ...
    (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
        ...
        sym.$('hotspot_validar').click(function(){
          ...
          for (i=1; i<=CrearCheckBox ; i++ ){
            var y = (parseInt(sym.$("checkbox_"+i).css("top")) + 14)+"px";
            var x = (parseInt(sym.$("checkbox_"+i).css("left")) - 25)+"px";
            //console.log('x: '+x+' , y: '+y);
            sym.$("checkbox_"+i).children(tipoactividad).each(function(){
				//la variable totalcheckbox es usada para verificar cuantas casillas deben estar seleccionadas
			  if(sym.getVariable("Respuesta_"+i)){
				  TotalCheckBox++;
			  }
          ...
          console.log("tot: "+Total+"   totCh: "+TotalCheckBox+"    Err: "+errores);
