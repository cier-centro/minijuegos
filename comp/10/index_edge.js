...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['202px', '102px','730px','83px','auto', 'auto'],
                opacity: 1,
                text: "¿Dónde tienen las personas mayores dificultades para acceder a la educación?",
                font: ['Arial, Helvetica, sans-serif', 38, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'TextCopy',
                type: 'text',
                rect: ['259px', '233px','583px','30px','auto', 'auto'],
                text: "NorteAmérica",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['198px', '229px','49px','50px','auto', 'auto'],
            ...
            },
            {
                id: 'TextCopy2',
                type: 'text',
                rect: ['26.4%', '290px','583px','58px','auto', 'auto'],
                text: "Europa",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['198px', '286px','49px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                id: 'TextCopy3',
                type: 'text',
                rect: ['26.4%', '347px','583px','58px','auto', 'auto'],
                text: "Suramérica ",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['197px', '343px','49px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                id: 'TextCopy4',
                type: 'text',
                rect: ['26.4%', '405px','583px','58px','auto', 'auto'],
                text: "África Subsahariana",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'checkbox_4',
                display: 'block',
                type: 'rect',
                rect: ['197px', '400px','49px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1491", tween: [ "style", "${_bt_solucion}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                ...
                { id: "eid1487", tween: [ "style", "${_TextCopy4}", "opacity", '1', { fromValue: '0'}], position: 750, duration: 700 },
                ...
                { id: "eid1490", tween: [ "style", "${_hotspot_solucion}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
