...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['202px', '100px','600px','103px','auto', 'auto'],
                opacity: 1,
                text: "¿Pueden las personas, mediante la educación, conseguir mejores empleos y disfrutar de una vida mejor?",
                font: ['Arial, Helvetica, sans-serif', 40, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'TextCopy',
                type: 'text',
                rect: ['259px', '314px','583px','30px','auto', 'auto'],
                text: "Sí, la educación reduce la desigualdad.",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['198px', '310px','49px','50px','auto', 'auto'],
            ...
            },
            {
                id: 'TextCopy2',
                type: 'text',
                rect: ['26.4%', '389px','583px','58px','auto', 'auto'],
                text: "No, el trabajo es la única opción.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'checkbox_2',
                display: 'block',
                type: 'rect',
                rect: ['198px', '385px','49px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1483", tween: [ "style", "${_bt_solucion}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                ...
                { id: "eid1479", tween: [ "style", "${_TextCopy2}", "opacity", '1', { fromValue: '0'}], position: 250, duration: 700 },
                ...
                { id: "eid1474", tween: [ "style", "${_Text}", "left", '200px', { fromValue: '-600px'}], position: 0, duration: 450 },
                ...
                { id: "eid1461", tween: [ "style", "${_bt_solucion}", "top", '483px', { fromValue: '590px'}], position: 950, duration: 300 },
                { id: "eid1463", tween: [ "style", "${_bt_reiniciar}", "top", '483px', { fromValue: '590px'}], position: 950, duration: 300 },
                { id: "eid1476", tween: [ "style", "${_TextCopy}", "left", '259px', { fromValue: '600px'}], position: 450, duration: 250 },
                ...
                { id: "eid1482", tween: [ "style", "${_hotspot_solucion}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
...
"bt_validar": {
    ...
    states: {
        "Base State": {
            "${_botones}": [
                ...
                ["style", "left", '-43px'],
                ["style", "background-position", [-74.671766493055,0], {valueTemplate:'@@0@@px @@1@@px'} ],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid1275", tween: [ "style", "${_botones}", "background-position", [-74.671766493055,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-74.671766493055,0]}], position: 0, duration: 0 },
                { id: "eid1274", tween: [ "style", "${_botones}", "background-position", [-76.165093315971,-70], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-74.671766493055,0]}], position: 250, duration: 0 },
