...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '220px','50px','50px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '285px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '350px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '415px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['21.1%', '90px','600px','103px','auto', 'auto'],
                opacity: 1,
                text: "¿Por qué hay tantas personas que pasan hambre?<br>",
                font: ['Arial, Helvetica, sans-serif', 40, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta4',
                type: 'text',
                rect: ['26.9%', '415px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Todas las anteriores.<br>",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta3',
                type: 'text',
                rect: ['26.9%', '350px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "La destrucción del medio ambiente.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta2',
                type: 'text',
                rect: ['26.9%', '285px','622px','45px','auto', 'auto'],
                opacity: 1,
                text: " Las guerras también han afectado negativamente la disponibilidad de alimentos.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta1',
                type: 'text',
                rect: ['26.9%', '221px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Las malas prácticas de recolección y el desperdicio de alimentos.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'help_checkbox',
            ...
            },
            {
                id: 'bt_ayuda',
                type: 'rect',
                rect: ['515px', '483px','45px','45px','auto', 'auto']
            },
            {
                id: 'bt_reiniciar',
                type: 'rect',
                rect: ['468px', '483px','45px','45px','auto', 'auto']
            },
            {
                id: 'bt_solucion',
                display: 'none',
            ...
            },
            {
                id: 'hotspot_validar',
                type: 'rect',
                rect: ['421px', '484px','45px','45px','auto', 'auto'],
                cursor: ['pointer'],
                fill: ["rgba(192,192,192,0.00)"],
                stroke: [0,"rgba(0,0,0,1)","none"]
            }],
    ...
    states: {
        "Base State": {
            ...
            "${_respuesta1}": [
                ["color", "color", 'rgba(38,68,103,1.00)'],
                ["style", "opacity", '0.008130080997943878'],
                ["style", "left", '26.94%'],
                ["style", "font-size", '25px'],
                ["style", "top", '221px'],
                ["transform", "scaleY", '1'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: false,
            timeline: [
                { id: "eid1394", tween: [ "transform", "${_checkbox_1}", "scaleY", '1', { fromValue: '0.01'}], position: 0, duration: 500 },
                ...
                { id: "eid1434", tween: [ "style", "${_hotspot_solucion}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid1432", tween: [ "style", "${_hotspot_solucion}", "display", 'none', { fromValue: 'none'}], position: 2250, duration: 0 },
                { id: "eid1435", tween: [ "style", "${_bt_solucion}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid1433", tween: [ "style", "${_bt_solucion}", "display", 'none', { fromValue: 'none'}], position: 2250, duration: 0 },
                ...
                { id: "eid1391", tween: [ "transform", "${_checkbox_4}", "scaleX", '1', { fromValue: '0.01'}], position: 185, duration: 500 },
                { id: "eid1393", tween: [ "transform", "${_checkbox_1}", "scaleX", '1', { fromValue: '0.01'}], position: 0, duration: 500 },
                ...
                { id: "eid1428", tween: [ "style", "${_respuesta4}", "opacity", '1', { fromValue: '0'}], position: 250, duration: 435 },
                ...
                { id: "eid1389", tween: [ "transform", "${_checkbox_3}", "scaleX", '1', { fromValue: '0.01'}], position: 125, duration: 500 },
                ...
                { id: "eid1429", tween: [ "style", "${_respuesta2}", "opacity", '1', { fromValue: '0'}], position: 125, duration: 430 },
                { id: "eid1238", tween: [ "style", "${_ok48}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid1395", tween: [ "transform", "${_checkbox_2}", "scaleX", '1', { fromValue: '0.01'}], position: 60, duration: 500 },
                ...
                { id: "eid1390", tween: [ "transform", "${_checkbox_3}", "scaleY", '1', { fromValue: '0.01'}], position: 125, duration: 500 },
                ...
                { id: "eid1427", tween: [ "style", "${_respuesta3}", "opacity", '1', { fromValue: '0'}], position: 185, duration: 435 },
                ...
                { id: "eid1392", tween: [ "transform", "${_checkbox_4}", "scaleY", '1', { fromValue: '0.01'}], position: 185, duration: 500 },
                ...
                { id: "eid1430", tween: [ "style", "${_respuesta1}", "opacity", '1', { fromValue: '0.008130080997943878'}], position: 60, duration: 435 },
                { id: "eid1396", tween: [ "transform", "${_checkbox_2}", "scaleY", '1', { fromValue: '0.01'}], position: 60, duration: 500 }            ]
        }
    }
},
"ok": {
...
"bt_validar": {
    ...
    states: {
        "Base State": {
            "${_botones}": [
                ...
                ["style", "background-position", [-72.222222,1.3888888888889], {valueTemplate:'@@0@@px @@1@@px'} ],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid1431", tween: [ "style", "${_botones}", "background-position", [-72.222222222222,-70], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-72.222222,1.3888888888889]}], position: 0, duration: 250 },
