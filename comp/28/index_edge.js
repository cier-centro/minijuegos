...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '230px','50px','50px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '295px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '360px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '413px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['21.1%', '89px','726px','103px','auto', 'auto'],
                opacity: 1,
                text: "¿Que problema tienen las personas que viven sin electricidad? Seleccione las respuestas correctas.<br>",
                font: ['Arial, Helvetica, sans-serif', 38, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta4',
                type: 'text',
                rect: ['26.9%', '414px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Muchos escolares no pueden hacer los deberes durante la noche.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta3',
                type: 'text',
                rect: ['26.9%', '360px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "No pueden tener facebook.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta2',
                type: 'text',
                rect: ['26.9%', '295px','622px','45px','auto', 'auto'],
                opacity: 1,
                text: "Las clínicas no pueden almacenar vacunas para los niños.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta1',
                type: 'text',
                rect: ['26.9%', '229px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Las mujeres y las niñas tienen que dedicar horas a ir en busca de agua.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'resp_incorrecta',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1432", tween: [ "style", "${_hotspot_solucion}", "display", 'none', { fromValue: 'block'}], position: 0, duration: 0 },
                { id: "eid1433", tween: [ "style", "${_bt_solucion}", "display", 'none', { fromValue: 'block'}], position: 0, duration: 0 },
...
"bt_validar": {
    ...
    states: {
        "Base State": {
            "${_botones}": [
                ...
                ["style", "left", '-43px'],
                ["style", "background-position", [-73.611111111111,0], {valueTemplate:'@@0@@px @@1@@px'} ],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid1431", tween: [ "style", "${_botones}", "background-position", [-73.611111111111,-70], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-73.611111111111,0]}], position: 0, duration: 250 },
