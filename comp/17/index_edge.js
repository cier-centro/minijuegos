...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'TextCopy',
                type: 'text',
                rect: ['26.4%', '213px','583px','30px','auto', 'auto'],
                text: "Identificar las comunidades vulnerables, y hacer valer sus derechos.",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['198px', '209px','49px','50px','auto', 'auto'],
            ...
            },
            {
                id: 'TextCopy2',
                type: 'text',
                rect: ['26.4%', '282px','583px','58px','auto', 'auto'],
                text: "Presionar a los gobiernos para eliminar las leyes, políticas y prácticas discriminatorias.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'checkbox_2',
                display: 'block',
                type: 'rect',
                rect: ['198px', '278px','49px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                id: 'TextCopy3',
                type: 'text',
                rect: ['26.4%', '352px','583px','30px','auto', 'auto'],
                text: "Promover la migración segura, regular y responsable.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'checkbox_3',
                display: 'block',
                type: 'rect',
                rect: ['198px', '348px','49px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                id: 'TextCopy4',
                type: 'text',
                rect: ['26.4%', '418px','583px','30px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['198px', '414px','49px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1446", tween: [ "style", "${_Text}", "top", '112px', { fromValue: '-100px'}], position: 0, duration: 450 },
