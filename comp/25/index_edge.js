...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '210px','50px','50px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '298px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['20.7%', '68px','700px','103px','auto', 'auto'],
                opacity: 1,
            ...
            },
            {
                id: 'respuesta2',
                type: 'text',
                rect: ['26.9%', '302px','622px','45px','auto', 'auto'],
                opacity: 1,
            ...
            },
            {
                id: 'respuesta1',
                type: 'text',
                rect: ['26.9%', '211px','639px','45px','auto', 'auto'],
                opacity: 1,
