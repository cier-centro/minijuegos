...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '205px','50px','50px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '293px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '355px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['20.7%', '63px','700px','103px','auto', 'auto'],
                opacity: 1,
            ...
            },
            {
                id: 'respuesta3',
                type: 'text',
                rect: ['26.9%', '355px','639px','45px','auto', 'auto'],
                opacity: 1,
            ...
            },
            {
                id: 'respuesta2',
                type: 'text',
                rect: ['26.9%', '300px','622px','45px','auto', 'auto'],
                opacity: 1,
            ...
            },
            {
                id: 'respuesta1',
                type: 'text',
                rect: ['26.9%', '206px','639px','45px','auto', 'auto'],
                opacity: 1,
