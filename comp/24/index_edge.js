...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '257px','50px','50px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '316px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '376px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '434px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['20.7%', '76px','738px','103px','auto', 'auto'],
                opacity: 1,
                text: "¿Para qué construir infraestructuras resilientes, promover la industrialización inclusiva y fomentar la innovación? Seleccione las respuestas correctas.",
                font: ['Arial, Helvetica, sans-serif', 36, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta4',
                type: 'text',
                rect: ['26.9%', '434px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Para ofrecer oportunidades a todas las personas.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta3',
                type: 'text',
                rect: ['26.9%', '376px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Para enfrentarnos al cambio climático.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta2',
                type: 'text',
                rect: ['26.9%', '316px','622px','45px','auto', 'auto'],
                opacity: 1,
                text: "Para el crecimiento económico.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta1',
                type: 'text',
                rect: ['26.9%', '258px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Para hacer edificios bonitos.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'resp_incorrecta',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1432", tween: [ "style", "${_hotspot_solucion}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid1433", tween: [ "style", "${_bt_solucion}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
...
"bt_validar": {
    ...
    states: {
        "Base State": {
            "${_botones}": [
                ...
                ["style", "left", '-43px'],
                ["style", "background-position", [-73.581271767361,0], {valueTemplate:'@@0@@px @@1@@px'} ],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid1431", tween: [ "style", "${_botones}", "background-position", [-75.554741753472,-70], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-73.581271767361,0]}], position: 0, duration: 250 },
