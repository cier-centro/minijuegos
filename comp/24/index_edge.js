...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['20.7%', '73px','692px','103px','auto', 'auto'],
                opacity: 1,
                text: "¿Para qué construir infraestructuras resilientes, promover la industrialización inclusiva y fomentar la innovación?",
