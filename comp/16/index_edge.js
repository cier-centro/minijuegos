...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                opacity: 1,
                text: "¿Señale ejemplos de desigualdad? Marque las respuestas correctas.",
            ...
            },
            {
                ...
                text: "Los canales de televisión<br>",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'checkbox_4',
...
"bt_validar": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid1468", tween: [ "style", "${_botones}", "background-position", [-75,-70], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-75,0]}], position: 0, duration: 250 },
