...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['20.7%', '96px','600px','63px','auto', 'auto'],
                opacity: 1,
                text: "¿Qué puedo hacer para ayudar a lograr este objetivo?",
                font: ['Arial, Helvetica, sans-serif', 40, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta4',
                type: 'text',
                rect: ['26.9%', '411px','639px','45px','auto', 'auto'],
                opacity: 1,
            ...
            },
            {
                ...
                opacity: 1,
                text: "Desarrollar una visión de futuro para tu edificio, calle y vecindario y actuar conforme a la misma.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta2',
                type: 'text',
                rect: ['26.9%', '279px','622px','45px','auto', 'auto'],
                opacity: 1,
                text: "Tomar nota de lo que funciona y de lo que no funciona en tu comunidad.<br>",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta1',
                type: 'text',
                rect: ['26.9%', '209px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Participar activamente en la gobernanza y la gestión de tu ciudad.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'checkbox_1',
                display: 'block',
                type: 'rect',
                rect: ['203px', '208px','50px','50px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '279px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '411px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
...
"bt_validar": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid1432", tween: [ "style", "${_botones}", "background-position", [-75,-70], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-72.222222222222,0]}], position: 0, duration: 250 },
