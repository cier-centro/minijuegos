...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '140px','50px','50px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '233px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['203px', '328px','50px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['21.1%', '79px','600px','45px','auto', 'auto'],
                opacity: 1,
            ...
            },
            {
                id: 'respuesta3',
                type: 'text',
                rect: ['26.9%', '328px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Todos podemos ahorrar electricidad enchufando los aparatos en una regleta, y apagándolos completamente cuando no se usan.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta2',
                type: 'text',
                rect: ['26.9%', '233px','622px','45px','auto', 'auto'],
                opacity: 1,
                text: "Incentivar los modos de transporte de menor consumo energético. Podemos ir en bicicleta, caminar o utilizar el transporte público.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'respuesta1',
                type: 'text',
                rect: ['26.9%', '141px','639px','45px','auto', 'auto'],
                opacity: 1,
                text: "Las empresas pueden mantener y proteger los ecosistemas para poder utilizar y desarrollar fuentes hidroeléctricas de electricidad.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'resp_incorrecta',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1433", tween: [ "style", "${_hotspot_solucion}", "display", 'none', { fromValue: 'block'}], position: 0, duration: 0 },
                { id: "eid1434", tween: [ "style", "${_bt_solucion}", "display", 'none', { fromValue: 'block'}], position: 0, duration: 0 },
...
"bt_validar": {
    ...
    states: {
        "Base State": {
            "${_botones}": [
                ...
                ["style", "left", '-43px'],
                ["style", "background-position", [-73.099772135415,0], {valueTemplate:'@@0@@px @@1@@px'} ],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid1431", tween: [ "style", "${_botones}", "background-position", [-73.099772135415,-70], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-73.099772135415,0]}], position: 0, duration: 250 },
