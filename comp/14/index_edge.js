...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['202px', '120px','600px','57px','auto', 'auto'],
                opacity: 1,
                text: "¿Qué puedo hacer para promover una vida sana?",
                font: ['Arial, Helvetica, sans-serif', 40, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'TextCopy',
                type: 'text',
                rect: ['26.4%', '216px','583px','30px','auto', 'auto'],
                text: "Exigir las vacunas correspondientes en la primera infancia.",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['198px', '212px','49px','50px','auto', 'auto'],
            ...
            },
            {
                id: 'TextCopy2',
                type: 'text',
                rect: ['26.4%', '280px','583px','58px','auto', 'auto'],
                text: "Tener una sexualidad responsable.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'checkbox_2',
                display: 'block',
                type: 'rect',
                rect: ['198px', '276px','49px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
            ...
            },
            {
                ...
                text: "Exigir a los gobiernos, y los dirigentes locales que mejoren el acceso de las personas a la salud y la asistencia sanitaria.",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
                id: 'checkbox_3',
            ...
            },
            {
                id: 'TextCopy4',
                type: 'text',
                rect: ['26.4%', '427px','583px','30px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['198px', '423px','49px','50px','auto', 'auto'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
                userClass: "check-on",
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1446", tween: [ "style", "${_Text}", "top", '110px', { fromValue: '-100px'}], position: 0, duration: 450 },
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1274", tween: [ "style", "${_botones}", "background-position", [-73.611111111111,-70], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-72.222222222222,0]}], position: 250, duration: 0 },
