...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['202px', '120px','722px','103px','auto', 'auto'],
                opacity: 1,
            ...
            },
            {
                id: 'TextCopy',
                type: 'text',
                rect: ['26.4%', '253px','583px','30px','auto', 'auto'],
                text: "3 millones.<br>",
            ...
            },
            {
                ...
                display: 'block',
                type: 'rect',
                rect: ['198px', '249px','49px','50px','auto', 'auto'],
            ...
            },
            {
                id: 'TextCopy2',
                type: 'text',
                rect: ['26.4%', '314px','583px','45px','auto', 'auto'],
                text: " 1 millón.<br>",
                font: ['Arial, Helvetica, sans-serif', 25, "rgba(38,68,103,1.00)", "normal", "none", ""]
            },
            {
            ...
            },
            {
                id: 'TextCopy3',
                type: 'text',
                rect: ['26.4%', '373px','583px','30px','auto', 'auto'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1446", tween: [ "style", "${_Text}", "top", '88px', { fromValue: '-100px'}], position: 0, duration: 450 },
...
"bt_validar": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid1275", tween: [ "style", "${_botones}", "background-position", [-73.611111,-68.055556222222], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-72.222222222222,0]}], position: 0, duration: 0 },
                { id: "eid1274", tween: [ "style", "${_botones}", "background-position", [-73.611111,-68.055556222222], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-73.611111,-68.055556222222]}], position: 250, duration: 0 },
                { id: "eid1301", tween: [ "style", "${_botones}", "top", '-22px', { fromValue: '-21px'}], position: 0, duration: 0 },
                { id: "eid1300", tween: [ "style", "${_botones}", "top", '-22px', { fromValue: '-22px'}], position: 250, duration: 0 },
