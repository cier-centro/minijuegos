...
"slide_1": {
    ...
    content: {
            dom: [
                ...
                {
                    rect: ['1px', '188px', 'auto', 'auto', 'auto', 'auto'],
                    id: 'btnac1',
                    transform: [[], [], [], ['0.85', '0.85']],
                    cursor: ['pointer'],
                    type: 'rect'
                },
                {
                    ...
                    type: 'rect',
                    cursor: ['pointer'],
                    rect: ['93px', '63px', 'auto', 'auto', 'auto', 'auto']
                },
                {
                    id: 'btnac3',
                    type: 'rect',
                    cursor: ['pointer'],
                    rect: ['172px', '231', 'auto', 'auto', 'auto', 'auto']
                },
                {
                    id: 'btnac4',
                    type: 'rect',
                    cursor: ['pointer'],
                    rect: ['299px', '249', 'auto', 'auto', 'auto', 'auto']
                },
                {
                    id: 'btnac5',
                    type: 'rect',
                ...
                },
                {
                    ...
                    type: 'rect',
                    cursor: ['pointer'],
                    rect: ['569px', '226', 'auto', 'auto', 'auto', 'auto']
                },
                {
                    id: 'btnac7',
                    type: 'rect',
                    cursor: ['pointer'],
                    rect: ['648', '291', 'auto', 'auto', 'auto', 'auto']
                },
                {
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid2104", tween: [ "style", "${_btnac6}", "top", '226px', { fromValue: '262px'}], position: 7000, duration: 750, easing: "easeOutBack" },
                ...
                { id: "eid2084", tween: [ "style", "${_btnac4}", "top", '249px', { fromValue: '286px'}], position: 6500, duration: 750, easing: "easeOutBack" },
                ...
                { id: "eid2094", tween: [ "style", "${_btnac5}", "top", '211px', { fromValue: '247px'}], position: 6750, duration: 750, easing: "easeOutBack" },
                ...
                { id: "eid2115", tween: [ "style", "${_btnac7}", "top", '291px', { fromValue: '331px'}], position: 7250, duration: 750, easing: "easeOutBack" },
    ...
    states: {
        "Base State": {
            "${_ac52}": [
                ...
                ["transform", "scaleX", '0.85'],
                ["style", "left", '-12px'],
                ["style", "clip", [142.35293579101563,166,334,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${symbolSelector}": [
                ["style", "height", '284px'],
                ["style", "width", '141px']
            ...
            "${_ac52Copy}": [
                ...
                ["transform", "scaleX", '0.85'],
                ["style", "left", '-12px'],
                ["style", "clip", [0,166,99.88235473632813,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ]
        }
    },
    timelines: {
...
"slide_21": {
    ...
    content: {
            dom: [
                ...
                {
                    rect: ['295px', '206px', '575px', '30px', 'auto', 'auto'],
                    id: 'TextCopy2',
