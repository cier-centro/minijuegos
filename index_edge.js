    ...
    content: {
            dom: [
                ...
                },
                {
                    ...
                    font: ['Arial, Helvetica, sans-serif', 16, 'rgba(255,255,255,1)', '100', 'none', 'normal'],
                    id: 'Text4',
                    text: 'Este minijuego responde al objetivo de la ONU #3: “Garantizar una vida sana y promover el bienestar para todos en todas las edades.”',
                    align: 'left',
                    type: 'text'
                }
            ],
...
"slide_18": {
    ...
    content: {
            dom: [
                ...
                {
                    rect: ['266px', '215px', '414px', '83px', 'auto', 'auto'],
                    borderRadius: ['5px 5px', '5px 5px', '5px 5px', '5px 5px'],
                    id: 'Rectangle8Copy6',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                    type: 'rect',
                ...
                },
                {
                    ...
                    font: ['Arial, Helvetica, sans-serif', 16, 'rgba(255,255,255,1)', '100', 'none', 'normal'],
                    id: 'Text6',
                    text: 'Este minijuego responde al objetivo de la ONU #8: “Promover el crecimiento económico sostenido, inclusivo y sostenible, el empleo pleno y productivo y el trabajo decente para todos.”',
                    align: 'left',
                    type: 'text'
                }
            ],
    ...
    states: {
        "Base State": {
            "${_ac8Copy}": [
                ...
                ["style", "left", '2px'],
                ["style", "clip", [0,110.41463470458984,96.34146118164062,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_hotspot}": [
    ...
    content: {
            dom: [
                ...
                },
                {
                    ...
                    font: ['Arial, Helvetica, sans-serif', 16, 'rgba(255,255,255,1)', '100', 'none', 'normal'],
                    id: 'Text9',
                    text: 'Este minijuego responde al objetivo de la ONU #7: “Garantizar el acceso a una energía asequible, segura, sostenible y moderna para todos.”',
                    align: 'left',
                    type: 'text'
                }
            ],
